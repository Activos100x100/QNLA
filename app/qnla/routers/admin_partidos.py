...
from app.qnla.schemas.partido import PartidoCreate, PartidoUpdate, PartidoOut, ResultadoIn
from app.qnla.routers.deps import get_admin_participante
from app.qnla.services.puntos_service import recalcular_pronostico

router = APIRouter(prefix="/qnla/admin/partidos", tags=["qnla-admin-partidos"])
